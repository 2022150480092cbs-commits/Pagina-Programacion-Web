...
export const AuthProvider = ({ children }) => {
    ...
    // Escucha en tiempo real si el usuario está conectado o no
    useEffect(() => {
    ...
    // Función de registro optimizada para el PSICEI
    const register = async (userData) => {
        ...
        try {
            ...
            // 2. Guardamos el nombre real directamente en el perfil nativo de Firebase Auth
            await updateProfile(userFirebase, {
                displayName: userData.name
            });

            // 3. Guardar los datos adicionales completos en Firestore
    ...
    const login = async (credentials) => {
        // Manejado en LoginForm por el momento
    };
